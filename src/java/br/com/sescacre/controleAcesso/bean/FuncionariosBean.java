...
import br.com.sescacre.controleAcesso.dao.CargosDAO;
import br.com.sescacre.controleAcesso.dao.CargosDoSetorDAO;
import br.com.sescacre.controleAcesso.dao.FuncionariosDao;
import br.com.sescacre.controleAcesso.dao.SetoresDAO;
import br.com.sescacre.controleAcesso.dao.UsuariosDao;
import br.com.sescacre.controleAcesso.entidades.Cargos;
import br.com.sescacre.controleAcesso.entidades.CargosDoSetor;
import br.com.sescacre.controleAcesso.entidades.Funcionarios;
import br.com.sescacre.controleAcesso.entidades.Setores;
    ...
    public String salvar() {
        ...
        try {
            ...
            if (funcionario.getIdFuncionarios() == null) {
                ...
                verificaEnvio = enviaEmail.enviaCad(funcionario.getEmail(), "Acesso ao Sistema de Controle de Acesso", funcionario.getUser().getLogin(), pass);
                if (verificaEnvio) {
                    msg.addMessage(null,
                            new FacesMessage(FacesMessage.SEVERITY_INFO,
